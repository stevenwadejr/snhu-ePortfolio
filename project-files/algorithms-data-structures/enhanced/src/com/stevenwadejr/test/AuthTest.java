package com.stevenwadejr.test;

import com.stevenwadejr.Auth;
import com.stevenwadejr.AuthRepository;
import com.stevenwadejr.User;
    ...
    private static void testLoginSucceeds() {
        ...
        AuthRepository staticRepo = new AuthRepository() {
            ...
            public Optional<User> findUserRecord(String username, String passwordHash) {
                return Optional.of(new User(givenUsername, givenPassword, givenRole));
            }
        };
